...
const create_prop=(req,res)=>{
    ...
    cloudinary.uploader.upload(req.file.path,(err,result)=>{
        ...
        let property= new Property(owner_id,status,price,state,city,address,type,image_url,cloudinary_id)
...
const updateProperty=(req,res)=>{
    ...
    Property.findPropertyById(id,(err,item)=>{
        ...
        if(!price || !state || !city || !address || !type ) {
            ...
            const propUpdate= new Property(req.user.id,item.status,price,state,city,address,type,image_url,cloudinary_id)
            
        Property.updatePropertyById(item.prop_id,propUpdate,(err,result)=>{
